      ...
      <main className="flex-1 grid place-items-center px-4">
        ...
        >
          ...
          <p className="mt-1 text-sm text-white/70">
            Sign up to access your buyer hub.
          </p>
          ...
          <form onSubmit={submit} className="mt-5 space-y-3">
            ...
            <Link
              href="/login"
              className="mt-2 inline-block w-full h-11 rounded-xl border border-white/15 bg-white/5 text-center grid place-items-center text-white/90 hover:bg-white/10"
            >
              Back to sign in
            </Link>
          </form>
