  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link className="underline" href="/admin/wines">
          ← Tutti i vini
        </Link>
      </div>

      <form
        action="/api/admin/wines/create"
        method="post"
        className="rounded border bg-white p-4 grid gap-4 max-w-3xl"
      >
        ...
        <p className="text-xs text-neutral-500">
          Dopo la creazione verrai reindirizzato alla pagina dettagli del vino per
          completare o caricare l’immagine.
        </p>
      </form>
    </div>
  );
